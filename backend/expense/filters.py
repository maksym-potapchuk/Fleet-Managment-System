...
class ExpenseFilter(django_filters.FilterSet):
    ...
    date_from = django_filters.DateFilter(field_name="expense_date", lookup_expr="date__gte")
    date_to = django_filters.DateFilter(field_name="expense_date", lookup_expr="date__lte")
